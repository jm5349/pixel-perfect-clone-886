              ...
              <Tabs defaultValue="details" className="w-full">
                ...
                <TabsContent value="details" className="mt-6">
                  <Card className="p-6 bg-gradient-to-br from-card via-card to-primary/5 border-primary/20 shadow-lg">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <h3 className="text-2xl font-extrabold text-primary">Product Details</h3>
                    </div>
                    <article className="prose prose-invert max-w-none">
                      {product.title.includes("Honda Civic") ? (
                        <div className="text-lg leading-relaxed space-y-4">
                          <p className="text-white font-extrabold text-lg">4-piece YF Original Design Front Bumper Lip Splitter Kit featuring:</p>
                          <ul className="space-y-3 text-white font-semibold text-base">
                ...
                <TabsContent value="specs" className="mt-6">
                  <Card className="p-6 bg-gradient-to-br from-card via-card to-primary/5 border-primary/20 shadow-lg">
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-1 h-8 bg-gradient-to-b from-primary to-primary/50 rounded-full"></div>
                      <h3 className="text-2xl font-extrabold text-primary">Specifications</h3>
                    </div>
                    <div className="grid grid-cols-3 gap-4">
                      <div className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-lg p-4 hover:shadow-md transition-all">
                        <h4 className="font-bold mb-2 text-primary text-base">Brand</h4>
                        <p className="text-white font-bold text-base">{product.vendor || "Yofer Design"}</p>
                      </div>
                      <div className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-lg p-4 hover:shadow-md transition-all">
                        <h4 className="font-bold mb-2 text-primary text-base">Type</h4>
                        <p className="text-white font-bold text-base">{product.productType || "Body Kit Component"}</p>
                      </div>
                      <div className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-lg p-4 hover:shadow-md transition-all">
                        <h4 className="font-bold mb-2 text-primary text-base">SKU/Variant</h4>
                ...
                <TabsContent value="fitment" className="mt-6">
                  <Card className="p-6 bg-gradient-to-br from-card via-card to-primary/5 border-primary/20 shadow-lg">
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-1 h-8 bg-gradient-to-b from-primary to-primary/50 rounded-full"></div>
                      <h3 className="text-2xl font-extrabold text-primary">Fitment Information</h3>
                    </div>
                    <div className="space-y-4">
                      <div className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-lg p-4">
                        <h4 className="font-bold text-primary mb-3 flex items-center gap-2 text-base">
                ...
                <TabsContent value="faq" className="mt-6">
                  <Card className="p-6 bg-gradient-to-br from-card via-card to-primary/5 border-primary/20 shadow-lg">
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-1 h-8 bg-gradient-to-b from-primary to-primary/50 rounded-full"></div>
                      <h3 className="text-2xl font-extrabold text-primary">Frequently Asked Questions</h3>
                    </div>
                    <Accordion type="single" collapsible className="w-full">
                      {faqItems.map((item, idx) => 
                        <AccordionItem key={idx} value={`item-${idx + 1}`} className="border-primary/20">
                          <AccordionTrigger className="text-left text-white hover:text-primary font-bold text-base">{item.q}</AccordionTrigger>
            ...
            <div className="md:hidden space-y-6">
              ...
              <Card className="p-4 bg-gradient-to-br from-card via-card to-primary/5 border-primary/20 shadow-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-xl font-extrabold text-primary">Product Details</h3>
                </div>
                {product.title.includes("Honda Civic") ? (
                  <div className="text-base leading-relaxed space-y-3">
                    <p className="text-white font-extrabold">4-piece YF Original Design Front Bumper Lip Splitter Kit featuring:</p>
                    <ul className="space-y-2.5 text-white font-semibold text-sm">
              ...
              <Card className="p-4 bg-gradient-to-br from-card via-card to-primary/5 border-primary/20 shadow-lg">
                <div className="flex items-center gap-2 mb-4">
                  <div className="w-1 h-6 bg-gradient-to-b from-primary to-primary/50 rounded-full"></div>
                  <h3 className="text-xl font-extrabold text-primary">Fitment Information</h3>
                </div>
                <div className="space-y-3">
                  <div className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-lg p-3">
                    <h4 className="font-bold mb-2 text-sm flex items-center gap-2 text-primary">
              ...
              <Card className="p-4 bg-gradient-to-br from-card via-card to-primary/5 border-primary/20 shadow-lg">
                <div className="flex items-center gap-2 mb-4">
                  <div className="w-1 h-6 bg-gradient-to-b from-primary to-primary/50 rounded-full"></div>
                  <h3 className="text-xl font-extrabold text-primary">Frequently Asked Questions</h3>
                </div>
                <Accordion type="single" collapsible className="w-full">
                  {faqItems.map((item, idx) => 
                    <AccordionItem key={idx} value={`item-${idx + 1}`} className="border-primary/20">
                      <AccordionTrigger className="text-left text-sm hover:text-primary font-bold text-white">{item.q}</AccordionTrigger>
