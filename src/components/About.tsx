  ...
  return <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Company Title */}
          <h2 className="text-2xl md:text-5xl font-automotive text-foreground mb-6 md:mb-8 tracking-tight">
            CUZTOMTUNING
          </h2>
          ...
          {/* Quote */}
          <blockquote className="text-xl md:text-3xl font-automotive text-primary italic mb-8 border-l-4 border-primary pl-6">
